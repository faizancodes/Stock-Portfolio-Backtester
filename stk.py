...
def getStockPrices():
    ...
    global purchaseCosts
    global capitalInStocks
...
def getPortfolioPerf():

    global portfolioMaxDrawdown
    global spyMaxDrawdown
    global betaCalc
    global alpha
    global sharpeRatio
    global infR
...
def exportFile():
    ...
    with open('C:\\Users\\faiza\\OneDrive\\Desktop\\StockData\\2020PortfolioTest.csv', 'w') as f:
